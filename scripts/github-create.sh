...
echo "Will create a new *$PRIVACYWORD* repo named engine-static"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo "Docker image for HTTP engine to serve static html/js sites."
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d "{\"name\": \"engine-static\", \"description\": \"Docker image for HTTP engine to serve static html sites.\", \"private\": $PRIVATE_TF}"
